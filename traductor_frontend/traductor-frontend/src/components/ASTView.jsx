      ...
      <div style={{ display: "flex", alignItems: "flex-start" }}>
        ...
        <div>
          ...
          <div style={{
            ...
            fontSize:      "0.85rem",
            fontWeight:    "600",
            boxShadow:     `0 4px 12px rgba(0,0,0,0.4), 0 0 20px ${color}40`,
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = `0 6px 16px rgba(0,0,0,0.5), 0 0 30px ${color}60`;
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = "scale(1) translateY(0)";
            e.currentTarget.style.boxShadow = `0 4px 12px rgba(0,0,0,0.4), 0 0 20px ${color}40`;
          }}
          >
            <span>{nodo.tipo}</span>
            {nodo.valor && (
          ...
          {tieneHijos && (
            <div style={{
              ...
              {nodo.hijos.map((hijo, i) => (
                <NodoArbol key={i} nodo={hijo} nivel={nivel + 1} />
              ))}
            </div>
          )}
        </div>
